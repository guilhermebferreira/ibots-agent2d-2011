 ...
 *Copyright:
 ...
 Universidade Federal do Tocantis  Maio/2010
...
bool Bhv_SetPlayJogadas::execute( PlayerAgent * agent )
{  std::cout  << "\n\n --------------\n executando setplayjogadas --------------\n\n ";
 ...
 */
void
Bhv_SetPlayJogadas::doKick( PlayerAgent * agent )
{
    dlog.addText( Logger::TEAM,
                  __FILE__": (doKick)" );
    //
 ...
 */
bool
Bhv_SetPlayJogadas::doKickWait( PlayerAgent * agent )
{
    const WorldModel & wm = agent->world();
 ...
 */
void
Bhv_SetPlayJogadas::doMove( PlayerAgent * agent )
{
    const WorldModel & wm = agent->world();
